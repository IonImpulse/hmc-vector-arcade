...
void initalize_embedded_system() {
    ...
    // Buttons
    pinMode(BTN_1_GPIO, BTN_1_PIN, GPIO_INPUT_PULLUP);
    pinMode(BTN_2_GPIO, BTN_2_PIN, GPIO_INPUT_PULLUP);
    pinMode(BTN_3_GPIO, BTN_3_PIN, GPIO_INPUT_PULLUP);
    pinMode(BTN_4_GPIO, BTN_4_PIN, GPIO_INPUT_PULLUP);
    pinMode(BTN_5_GPIO, BTN_5_PIN, GPIO_INPUT_PULLUP);
    pinMode(BTN_6_GPIO, BTN_6_PIN, GPIO_INPUT_PULLUP);
    pinMode(BTN_7_GPIO, BTN_7_PIN, GPIO_INPUT_PULLUP);
    pinMode(BTN_8_GPIO, BTN_8_PIN, GPIO_INPUT_PULLUP);
    pinMode(BTN_9_GPIO, BTN_9_PIN, GPIO_INPUT_PULLUP);
    pinMode(BTN_10_GPIO, BTN_10_PIN, GPIO_INPUT_PULLUP);
}